...
void Init__dealer(){
    ...
    rb_define_method(cClient, "send_manual", (VALUE(*)(...))&dealer_manual_send, 1);
    ...
    rb_define_method(cClient, "remove_stored_message_for", (VALUE(*)(...))&dealer_remove_stored_message_for, 1);
    /* Response class */
